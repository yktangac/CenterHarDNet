...
def draw_box_3d(image, corners, c=(0, 0, 255)):
  #bug: cv2.error: OpenCV(4.5.2):-1: error:(-5:Bad argument) in function 'line'
  # corners[f[j+1]%4,0] <---- floating points but require intger type
  #Solution: force corners[xxxx] to be integer type --> int(coner[xxxx])
  #cv2.line(image,start_points,end_points,color,thickness)
  #
  face_idx = [[0,1,5,4],
              [1,2,6, 5],
              [2,3,7,6],
